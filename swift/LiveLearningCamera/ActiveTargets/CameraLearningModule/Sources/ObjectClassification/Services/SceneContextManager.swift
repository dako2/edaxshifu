...
public struct AnalyzedScene {
    public let timestamp: Date
    public let sceneType: SceneType
    public let objects: [MemoryTrackedObject]
    public let relationships: [SpatialRelation]
    public let activities: [DetectedActivity]
    public let graph: SceneGraphData
}
...
public struct SpatialRelation {
    public let object1: MemoryTrackedObject
    public let object2: MemoryTrackedObject
    public let type: SpatialRelationType
...
public struct DetectedActivity {
    public let type: DetectedActivityType
    public let participants: [MemoryTrackedObject]
    public let confidence: Float
}
...
public struct SceneGraphData {
    public let nodes: [SceneNodeData]
    public let edges: [SceneEdgeData]
}
